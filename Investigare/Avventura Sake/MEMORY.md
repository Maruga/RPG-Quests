...
## Stampa conclusa (2026-09-18)
Richiesta autore: finire per stampare, senza ulteriori ripensamenti. Corretta soltanto l'impaginazione CSS; verificato che il corpo dei 16 HTML sia identico alla versione Git precedente. PDF pronti in `handout/PDF_STAMPA/`, singoli e `TUTTI_HANDOUT.pdf`: 19 pagine A4, prime due orizzontali, agenda quattro pagine, ogni altro handout una pagina. Tutte le pagine controllate visivamente e testo entro i bordi. Stampa: solo fronte, dimensioni effettive 100%, orientamento automatico. Esportatore locale: `handout/stampa_pdf.py`. Il problema di impaginazione del controllo del 17 settembre è risolto; non riaprire le proposte narrative o di contenuto di quel rapporto senza richiesta dell'autore.

## Controllo pre-gioco (2026-09-15) — decisioni dell'autore, applicate
Rapporto: `CONTROLLO_PRE-GIOCO_2026-09-15.md`. Principio dell'autore: **è uno scenario, non un'avventura in sequenza**; **niente Gou e niente Kage nell'avventura** (stanno sulle schede dei PG, li gestisce il GM; i PG possono essere altri); **è un'avventura, non la realtà**: non si spiega tutto (la pistola di Ogawa «ce l'ha in tasca, punto»).
**Applicato** (storia + copie in `PNG/` e `Location/`): (1) giardino 21:30 — Hayashi Kenji (socio giovane) vicino allo stagno, Yuki e Nakamura sulla panchina, i tre si sono visti; (2) Endo e Toda confermano Akemi in cucina per l'acqua; (3) «alla fine dell'anno le cose cambieranno» la sente Ishii Takuya (cameriere) a un brindisi; (4) Nishida spiega le chiamate dopo l'8/10 (saldo + «novità su Hayashi?»); (5) tolti tutti i Gou; (6) tolta la sezione Kage; (7) **finale con la pistola**: Ogawa comparsa v3.1 (Distacco 5 · Pazienza 6 · Silenzio 6 · Lucidità 6 · Ascolto 5 · Presenza 4 · Ki 8), compatta .22/.25 (Lucidità/Distacco, 2/1/4, danno 3, 3 colpi), sorpresa su Ascolto, sala principale, vuole uscire dal giardino; con prove parziali nega e chiede l'avvocato; in Scena 0 il GM chiede se i PG hanno prelevato la pistola; (8) H03 Endo 9 anni, H12 timbro 14/11, tolto «registro chiamate» dal telefono dello studio (1997), CLAUDE.md aggiornato (durata 60-90, `png notevoli/`).
**Schede in `PNG/` rinominate** (2026-09-15, richiesta autore): `Nome Cognome - ruolo.md` (es. `Tanaka Yuki - moglie della vittima.md`, `Ogawa Masaru - colpevole, direttore R&D.md`), per trovarle senza conoscere i nomi giapponesi. Nessun wikilink le puntava. I file in `Token/` hanno ancora i nomi vecchi.

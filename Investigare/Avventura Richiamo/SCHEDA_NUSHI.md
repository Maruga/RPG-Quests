...
## 2. Dimensioni e massa *(canone: 120 m)*

| Misura | Valore | Nota |
|---|---|---|
| **Altezza eretta** (vertice del capo) | **120 m** | classe Shin-Gojira (118,5 m) |
| Altezza in marcia (postura ricurva, al dorso) | ~100 m | come appare nelle foto |
| Altezza d'anca | ~43 m | proporzione bipede (36% dell'altezza) |
| Cranio | ~28 m di lunghezza · mandibola larga ~20 m | «una testa grande come un palazzo di dieci piani» |
| Larghezza alle spalle | ~60 m | |
| Coda | ~170 m | armata, tenuta bassa; in acqua fa da propulsore |
| **Lunghezza totale muso-coda** | **~290 m** | tre isolati |
| Placche dorsali | fino a ~18 m l'una | la «scogliera che cammina» vista dai pescherecci |
| **Membrana dell'organo di risonanza** | **~15 m di diametro** | dietro la mandibola, alla base del cranio — **il punto debole**; a questa scala si vede fremere anche dalle foto aeree |
| Piede | ~20 × 13 m · impronta ~200 m² | |
| Passo | ~26 m (falcata doppia ~52 m) | **un appoggio ogni ~4-5 secondi**: il «tamburo» che si sente nei palazzi a chilometri |
| **Massa** | **~100.000 t** | densità ≈ acqua, come ogni animale |
| Pressione al suolo | ~25 kg/cm² (2,5 MPa) | 15-20 volte un elefante: **sprofonda 0,5-1 m** nei suoli agricoli, sfonda solette, metropolitane e parcheggi interrati; i viadotti crollano al passaggio |

---

## 3. Fisiologia *(canone design §3.1, esteso)*
...
## 6. Punti deboli *(il cuore degli indizi — ognuno va scoperto in gioco)*
...
**Cosa NON funziona:** ogni arma. Il .38 di ordinanza non arriva nemmeno al derma; l'artiglieria fa schegge superficiali senza cambiargli rotta; il rischio vero del fuoco pesante è **dove cade un corpo da centomila tonnellate** — per questo nessuno spara (linea ufficiale JSDF: assetto soccorso disastri). **E peggio: ogni colpo che la raggiunge carica la molla** (v. sotto).

### L'arma segreta — la pazienza *(canone GM 2026-08-20: `arma-kaiju.md` — MAI mostrare al tavolo)*
...
| Distanza | Effetto |
|---|---|
| ~4 km | il malessere: nausea lieve, ansia, vetri che vibrano, cani e uccelli impazziti — **è il sintomo-indizio** che precede ogni passaggio |
...
## 9. La scia *(derivata dai numeri canonici; le voci di colore sono proposte)*
...
- **La scia di superficie**: una V da superpetroliera lunga chilometri; di notte **brilla** (bioluminescenza — colore): è la scia che i pescatori raccontano prima ancora di aver visto le placche.
- **Le onde di spostamento**: al passaggio sotto costa, risacche da 0,5-1 m nei porti — barche strappate agli ormeggi, mareografi impazziti: **un'altra rete di tracciamento gratis**.
- **Il fiume di fango**: filtrando smuove il fondale: una piuma torbida lunga chilometri, visibile dagli aerei; le reti tornano su piene di limo.
- **Il solco sul fondale**: dove il fondo è sotto i ~100 m cammina invece di nuotare: i pescherecci a strascico trovano una **trincea dragata** — la rotta si mappa anche da sotto.
- **La banda svuotata**: dietro di lei il mare è filtrato: settimane di pesca magra lungo la rotta — la rabbia delle cooperative fa parte della scia.
- **Il canto**: porta per centinaia di km: branchi che fuggono la rotta e **spiaggiamenti** di cetacei sulle spiagge sbagliate (i biologi ci leggono la conferma degli infrasuoni); le flottiglie dei calamari — è stagione — **si aprono al suo passaggio** come un sipario di lampare.
- **La nuvola di gabbiani**: migliaia, a banchettare sulla scia di filtrazione: **si vede lei prima delle placche**, a dieci chilometri.

### Leggere la scia *(per gli investigatori: quanto tempo fa è passata?)*

| Età | Segni |
|---|---|
| 0-2 h | polvere in aria, geyser dalle condotte, gas nell'aria, gabbiani sopra la linea |
| 2-12 h | pozze torbide, fughe di gas transennate, uccelli muti, fango ancora lucido |
| 12-48 h | pozze che si schiariscono, odore di marea che cala, squadre dell'ente elettrico al lavoro |
...
## 11. Prompt per le immagini — «vedere le cose importanti»

**Come usarli** (workflow già in uso: GPT Image / Nano Banana):
1. **Coerenza del design**: quando il tool accetta immagini di riferimento, allega una delle due foto aeree esistenti («stessa creatura di questa foto») — è il metodo ritratti+reference già collaudato.
...
**P1 · Tavola di scala** — riferimento per il tavolo (quanto è grande davvero). → `Immagini/Scheda_Scala.png`
> Technical concept sheet, clean orthographic side view and front view of a colossal 120-meter kaiju: charcoal-black craggy hide like wet volcanic rock, rows of jagged obsidian dorsal plates from skull to tail tip, hunched bipedal posture, massive columnar legs, long 170-meter armored tail. Beside it, scale silhouettes: a 100-meter apartment tower, a 40-meter fishing trawler, a train car, a human figure. White background, thin measurement lines and Japanese annotations, museum infographic style.
...
> Low-angle photograph from a road bridge over a river: a 1980s Japanese fire-brigade ladder truck extended upward, a large industrial acoustic horn mounted on the ladder aimed straight at the head of the monster above, cables taut, tiny firefighters and policemen in respirator masks and rain capes bracing at the base. Thirty meters above, filling the frame, the head of a colossal black kaiju rearing back, the taut drum-like membrane behind its jaw lit white by floodlights, mud and spray exploding around. Night, rain of silt, dramatic but grounded, grainy photojournalism, Japan 1986.

~~**P11 · L'emettitore su tetto**~~ — **DEPENNATO (2026-08-21)**: era del vecchio impianto a emettitori fissi; nel canone l'emettitore sta **dentro il camioncino**, e la foto-reperto esiste già (`Immagini/Camioncino Interno.png`, F7).

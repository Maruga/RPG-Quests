...
## Indizio 1 — Il camioncino *(canone utente 2026-08-19)*

### La verità del GM

I segnali che attirano il mostro viaggiano dentro **camioncini tutti uguali**, travestiti da mezzi di cantiere.
...
| **La carica** | **Ogni camioncino è imbottito d'esplosivo** (intercapedine del pianale): serve a **farlo saltare e cancellare le prove**. Se scoperti e alle strette, i mercenari **attivano la demolizione — un minuto di timer — e scappano**. Per questo un camion preso intero è raro e prezioso | **canone utente 2026-08-23** |
...
| Quanti | **DUE per centrale: il faro + il mezzo di supporto** («due unità per posizione» — la lettera di bordo) = **16 sulla rotta**, più eventuali riserve. *(Interpretazione: il supporto è la ridondanza della tappa — se la polizia demolisce il faro attivo, il supporto accende il suo: per salvare una centrale vanno zittiti ENTRAMBI)* | **canone utente 2026-08-23** (due per centrale); interpretazione da validare |
...
> **La tattica** *(canone 2026-08-21; agg. 2026-08-23 col supporto)*: **per salvare una centrale vanno zittiti il faro E il suo supporto prima dello sbarco** — morto il segnale della tappa, la squadra della tappa successiva accende il proprio (la catena si auto-ripara) e la bestia tira dritto, al largo, verso il faro dopo. **Se vengono distrutti TUTTI, il mostro torna all'acqua** — è la seconda via di vittoria, accanto al disturbatore. E **un prigioniero di un camioncino può rivelare il capannone** (come l'ostaggio della consegna: credendolo ormai vuoto).
> **Handout pronto**: **`HANDOUT_CAMIONCINO.html`** — il rapporto d'esame del camioncino catturato (meccanismo del richiamo + la carica) con la **lettera di bordo**: trasferimento al punto ７, il mezzo di supporto («due unità per posizione»), la procedura di demolizione. Data e numeri di protocollo da compilare a penna.

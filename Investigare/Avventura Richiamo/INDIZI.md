...
- **Ubicazione: un CAPANNONE — non un appartamento — nella zona di Wakasa/Maizuru** (decisione utente 2026-08-20, zona indicata su mappa). Identità proposta: **l'ex cantiere di demolizioni navali sul porto OVEST di Maizuru** (~35.4495 N, 135.3330 E — da fissare su carta) — capannone grande con **banchina propria** (il dispositivo è arrivato via chiatta), **dall'altra parte della baia rispetto alla Sala 2** (~5-6 km in linea d'aria): si nascondono all'ombra del pennone. Il passaggio del 3d gli sfiora il tetto (~0,9 km): il covo sopravvive per un pelo. Mappa a zone e guarnigione: `SCONTRI.md` §3.

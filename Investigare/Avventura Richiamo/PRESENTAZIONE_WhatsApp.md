# Presentazione del gioco — gōgai del «Genkai Shimpō» (per WhatsApp)

**Cos'è**: il testo di presentazione dell'avventura da mandare ai giocatori su WhatsApp — l'edizione
straordinaria (gōgai 号外: il foglio gratuito distribuito in strada) del quotidiano locale, il giorno
dopo la distruzione della centrale di Genkai. Testata inventata (come NKB per il telegiornale).
**Data proposta**: distruzione mercoledì 5 novembre 1986 all'alba → gōgai giovedì 6 (da confermare).
**Allineato alle mappe utente del 19/08** (la «V di Genkai», `Immagini/Mappa_01/02`): arrivato dal
mare a ponente, attraversato il promontorio distruggendo tutto, sparito nel mare a levante-nordest.
...
```
*玄海新報 — GENKAI SHIMPŌ*
_Gōgai · edizione straordinaria · giovedì 6 novembre 1986 · distribuzione gratuita_
...
I pescatori hanno una parola per il suono che faceva di notte: _uminari_, il rombo del mare. Ma i vecchi di Madara, per la cosa che lo faceva, ne usano una più antica: *il Nushi*. Il Padrone.
...
*Coda opzionale da appendere sotto, se vuoi firmare l'invito al tavolo:*

```
*GENKAI — RICHIAMO* · Giappone, novembre 1986 · si gioca.
```

**Nota**: la testata dice Genkai 玄海 (il mare), il gioco dice Genkai 限界 (il limite) — stessa
lettura, kanji diversi: il gioco di parole è il titolo della campagna.

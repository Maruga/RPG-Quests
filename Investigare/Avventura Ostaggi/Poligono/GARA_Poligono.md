...
Le sagome salgono ogni 7 momenti e partono dalla 2, 3, 4, 1, 6, 5, 7.
...
5. **Iniziativa normale, un ultimo scambio.** Adesso tutti sanno tutto: lei è a terra, quindi chi le spara ha +1 (lei stesa). Lei spara ancora due colpi (finito i colpi).
6. **La sirena.** Fine prova. Lo scambio con lei non si conclude, e non deve: l'esercitazione è finita quando gli istruttori hanno visto quello che volevano vedere. Hirano si toglie la visiera e fa il conto ad alta voce: chi porta il gesso, e dove.

# CLAUDE.md — L'Ultima Lezione

Questo file riguarda SOLO l'avventura "L'Ultima Lezione". Per il regolamento GENKAI e i PG premade, vedi la directory padre (`Investigare/`). Per le altre avventure, vedi le rispettive cartelle.
...
**L'Ultima Lezione** — avventura investigativa per GENKAI 限界 v1.2. Ambientata a Kyoto, Novembre 1997. Un professore universitario si suicida orchestrando tutto affinché sembri un omicidio, per incastrare il collega che gli ha plagiato la ricerca e garantire l'assicurazione alla figlia. Non esiste un colpevole. Il caso ha 3 finali possibili, nessuno "giusto".

Tutto il materiale è in **italiano**. L'avventura è contenuta in `Storia Completa.md` (~925 righe).

## Lore Critiche (MAI violare)

- **Ambientazione 1997**: NO internet per civili comuni, NO cellulari per gente normale. L'università di Kyoto HA internet (Netscape Navigator). Telefoni fissi, fax, cercapersone per polizia
- **Morimoto si è suicidato** — non esiste un assassino. Questa è la verità che i PG devono scoprire (o fallire)
- **Metodo**: aconitina nel collirio (via oculare). Veleno estratto dal trikabuto raccolto sui monti Kitayama
- **Aconitina NON nei pannelli autoptici standard** — serve analisi HPLC su richiesta specifica. Senza sospetto, la morte resta "arresto cardiaco"
- **Morimoto muore A CASA** (Sakyo-ku, Tetsugaku-no-Michi 14), non all'università. Chiama il 119 da casa. Muore in ospedale alle 22:30
- **Lo studio all'università** (307, Facoltà di Lettere) contiene prove FALSE preparate da Morimoto nei giorni precedenti: lettera, diario, documenti in disordine
- **Il collirio avvelenato** è trovato a casa (Reperto A), NON allo studio. Allo studio c'è solo lo spazio dove lo lasciava di solito
...
- **Se i PG chiudono il caso prematuramente**: hanno fallito, un innocente va in prigione. Nessuna valvola di sicurezza
- **Gli indizi si danno SEMPRE** — il dado non blocca l'indagine, modula solo la gestione emotiva
- **Caso Kamiya 1986** (Torikabuto Hoken-kin Satsujin Jiken): riferimento storico reale. Ogni investigatore giapponese del 1997 lo conosce. Funziona come depistaggio (rafforza l'ipotesi omicidio per assicurazione)
...
7. Morte ore 22:30, diagnosi iniziale: arresto cardiaco
8. Caso riaperto 3 giorni dopo per richiesta Nippon Life → analisi HPLC → aconitina → omicidio

## Schema dei Depistaggi

| Elemento | Sembra dire | In realtà |
|----------|-------------|-----------|
| Lettera "se mi succede qualcosa" | Morimoto aveva paura di Kuroda | Fabbricata per incastrare Kuroda |
...
- **Tanabe Shigeru** (62, custode) — conferma accessi Kuroda, vede Morimoto uscire il 12/11 alle 17:30
- **Takagi Ryuichi** (52, ispettore capo) — pressione per chiudere. Non antagonista, pragmatico
- **Dr. Endo Hiroshi** (50, medico) — segreto professionale. Rivela depressione, antidepressivi, mani irritate
- **Honda Masao** (60, preside) — vuole chiudere lo scandalo. Sa dei problemi finanziari
- **Yamaguchi Keiko** (45, editrice) — conferma il plagio documentalmente
- **Sato Nobuo** (42, assicuratore) — rivela che Morimoto ha chiesto della clausola suicidio
- **Mori Katsuo** (55, collega neutrale) — Morimoto era "diverso, più tranquillo, come se avesse trovato pace"
- **Commesso Montbell** (senza nome) — riconosce Morimoto, non riconosce Kuroda
- **Gestore chiosco montagna** (senza nome) — "pesce fuor d'acqua" sui Kitayama

## Struttura del File

`Storia Completa.md` contiene tutto in sequenza:
1. Panoramica e premessa
2. La vittima — Morimoto (biografia, spirale, decisione)
3. Il falso colpevole — Kuroda
4. Il piano di Morimoto (Fase 1: preparazione, Fase 2: esecuzione)
5. I personaggi — schede PNG complete con En per PG
6. Le location (9 totali: studio, ufficio Kuroda, casa Morimoto, casa Aoi, ospedale, Montbell, chiosco montagna, editrice, stazione polizia)
7. Struttura dell'indagine (Fase 1: "il caso facile", Fase 2: "la verità fa male")
8. Indizi e percorsi (A: caso falso, B: dubbi, C: verità)
9. Note GM (ritmo, toni, quando tirare, Gou utili, dilemma finale)
10. Reazioni alla scoperta, evento reattivo (diario), fallimento legittimo
11. Cronologia completa (1987-1997)
...
|---|------|-----------|-------------|
| 01 | Rapporto_Preliminare | Intervento paramedici, ritrovamento, riapertura caso | Briefing |
| 02 | Autopsia_Standard | Referto 13/11, arresto cardiaco, tossicologia negativa | Briefing |
| 03 | Rapporto_Tossicologico | HPLC 15/11, aconitina positiva, riferimento Kamiya | Briefing |
...
| 08 | Cronologia_Browser | 16 URL Netscape recuperati (mix accademico + sospetto) | Dopo 24-48h dalla richiesta di recupero dati |
...
| 15 | Caso_Kamiya_1986 | Scheda archivio caso Torikabuto 1986: aconitina + assicurazione = precedente | Briefing — Takagi lo cita |
...
| 18 | Giornale_Omicidio | Kyoto Shimbun 16/11 — veleno nel collirio, caso riaperto, parallelo Kamiya | Briefing (stesso giorno) |
...
- Ogni PNG ha En (legame) con valore numerico differenziato per PG
- Le schede PNG seguono lo schema: dati, cosa sa, cosa nasconde, come reagisce, En
...
- Ritmo target: due fasi narrative (Fase 1: caso facile, Fase 2: ribaltamento). Durata variabile a seconda del tavolo
- I PG sono gli stessi delle altre avventure (Yamamoto, Honda, Nakamura, Sato, Fujita)

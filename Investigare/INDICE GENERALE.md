...
| File | Trigger |
|------|---------|
| [[Lettera_Suicidio_Noboru]] | Solo se Noboru si suicida |
...
| [[PG_05_Fujita_Emi]] | Profiler | Creditore |
...
### Eventi reattivi
```
Mori parla         → Muore entro 24h
Noboru scoperto    → Seppuku + lettera
Penna non presa    → Sakura la fa sparire
```

### Contatti utili PG
| PG | Conoscenza | Utilità |
|----|------------|---------|
| Yamamoto | Giornalista | Archivi, voci |
| Honda | Informatore | Sottobosco |
| Nakamura | Avvocato | Legale, tribunale |
| Sato | Informatico | Recupero dati |
| Fujita | Medico legale | Autopsie |
...
*Da generare - vedi prompt nel file separato*

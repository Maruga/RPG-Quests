...
5. **Ki** — calcolo guidato: **Ki max = attributo più basso + 2d6 (prendi il dado PIÙ ALTO)**, un **1 si ritira una volta**, **tetto 12**. Bottone "tira" (riuso dei dadi del wizard). Qui si SPIEGANO (senza input): **Genkai** = crollo a Ki ≤3; **Nasake** (riserva 1, parte vuota); **Soroban** (parte da 5 ogni giornata).

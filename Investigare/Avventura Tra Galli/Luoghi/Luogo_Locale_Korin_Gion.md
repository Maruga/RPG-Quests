...
- **Secondo registro** nascosto in una cassetta dietro un pannello del controsoffitto dell'ufficio (movimenti scommesse in codice — Tachibana lo aggiornava ogni domenica mattina)
- Telefono fisso del locale: appare nel registro chiamate del cellulare della vittima
- Nessun cliente del giro scommesse veniva mai qui (Tachibana separava le attività)
...
- Il **secondo registro** è la prova decisiva per ricostruire i movimenti finanziari di Tachibana

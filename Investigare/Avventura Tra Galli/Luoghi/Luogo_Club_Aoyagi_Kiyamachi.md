...
> Locale di hostess di alto livello dove lavora Aoyagi Mariko, amante di Tachibana. Frequentato da imprenditori, professionisti, alcuni clienti di Tachibana.
...
- **Mama-san Reiko** (48) — gestisce le hostess
- **8 hostess regolari**, tra cui **Mariko (Mari)**
- **2 baristi**, **1 pianista**

## Indagine
- Aoyagi Mariko è l'oggetto principale dell'indagine qui
- Mama-san Reiko è collaborativa se trattata con discrezione: conferma la relazione di Mariko con Tachibana, conferma le date in cui lui ha frequentato il locale
...
- Registro clienti (Tachibana frequentava 2-3 volte al mese, sempre da solo o con un cliente d'affari)
- Conti del 2 febbraio 1998: Tachibana ha cenato qui con un uomo descritto come *"sui 30 anni, casual, sneaker"* (descrizione coerente con Hayashi — ultima cena d'affari prima della morte)

...
- **2 cameriere** (turnistica): Suzuki, Hayama — ignare
...
- I PG che intervistano Tachi Yūichirō: l'uomo è spaventato, evita di parlare, dice solo "*sono solo il gestore*", possibile crollo se pressato (chiave: la moglie Reiko è completamente innocente — minacciare il suo coinvolgimento legale lo fa cedere)

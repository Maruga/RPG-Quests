...
| **Kokuzei** | La polizia tributaria (reati fiscali) |
...
4. **Codice di comunicazione**: ogni mese il Kameoka-tei (il ristorante di copertura) pubblica un annuncio sul **Kyoto Shimbun** (il quotidiano locale di Kyoto), sezione "Annunci ristorazione". La "promozione speciale del [data]" è la data del combattimento (ore 23:00 al capannone). I 7 piatti del menu = 7 combattimenti della serata, con nomi poetici che sono i codici dei galli. Gli sconti in % = le quote di partenza. //I nomi dei galli sono le salse, esempio wasabe, agrodolce, i galli si chiamano cosi Wasabe, ... quindi pollo alle mandorle con due salse le salse indicano i nomi dei galli e nello stesso piatto chi combatte, l sconto è la scomessa sconto 5% significa 1 a 5, 7% significa 1 a 7.//
...
7. **Antefatti Murakami (il veterinario complice)**: **Dr. Murakami Saburō** (52, veterinario di Yamashina — quartiere a est di Kyoto —, sposato con **Hiroko**, padre di **Kenji** 19 e **Aiko** 15) inizia nel 1994 a curare in nero i galli del Nitōgun (la banda).
...
10. **Preparazione (novembre 1997 – gennaio 1998)** — 2 prestanome ignari:
    ...
    - **Nishimura Tatsuya** (36, cameriere senior del Kōrin — il locale di Tachibana //chi cazzo è mi devi metyter chi è// a Gion —, fedele al datore di lavoro) → scommette ¥800k senza fare domande
...
14. **Trappola Tachibana — fase 1**: 10 febbraio mattina, Hayashi (il braccio destro) fa una ricognizione preventiva del bagno maschile al 3° piano della Kyoto Station (la stazione centrale), lato Hachijō (l'uscita sud). Sceglie il punto e nota il cartello che segnala la telecamera fuori servizio dal 9 febbraio. //le telecamere funzionano, tanto assassino ha il volto coperto e si muove bene, si capisce che è un professionista//
...
24. **Autopsia 14/02 mattina**: rivela una concentrazione di xilazina (il sedativo veterinario) 5 volte superiore alla dose letale, più un ematoma da contenimento al collo. **Omicidio mascherato da suicidio**. I PG, leggendo il referto la sera del 14/02, collegano i due morti. //il caso viene però prima dato ad altra squadra che poi lo passa a loro perchè risultano coincidenze nel caso qualche giorno dopo, mentre i pg possono anche scoprirlo andando nell'ambulatorio del veterinario perchè seguono le traccie dal telefono, ma non gli viene consegnato nulla inizialmente//
...
26. **Identikit dell'assalitore**: dal racconto di Ōkubo (l'usuraio, che lo intravede di sfuggita) e del vicino di casa (testimone secondario, accecato dai propri fari), la polizia produce un **identikit non preciso**: maschio, ~28 anni, atletico, ~1,80 m, capelli rasati, giubbotto scuro imbottito, sneaker scure con suola scanalata. Volto vago. Utile per confronti futuri (la telecamera del corridoio alla Kyoto Station, la perquisizione di casa Kuroda) ma **non sufficiente da solo** a identificare Kuroda (il sicario).
...
37. **Climax — 22 febbraio ore 23:00**: prossimo combattimento al capannone di Kameoka. I PG coordinano un blitz con la **Sezione Crimine Organizzato** della Polizia Prefetturale di Kyoto (escludendo la Polizia di Kameoka per via di Inagaki, il sergente corrotto). Squadra speciale di ~30 uomini, briefing tattico la mattina del 22/02. Esito: arresti di 50–70 persone, sequestro di contante e registri reali. Saitō (il capo) presente o assente in base al timing. //volevo far fare un combattimento ai PG se vogliono, pensavo questo quando la polizia arriva, alcune della banda gregari sono appostati e avvisano, da li alcuni iniziano a sparare dalle finestre, molta gente scappa se i gregari la vedono male si tolgono tutto e provano a confodersi con la gente. Facciamo un bel combattimento da finestre e porta sul piazzale, la polizia ovviamente circonda//
...
- **Codice dei combattimenti**: il "menu sconti" elenca i 7 combattimenti della serata. //ti ho scirtto come deve essere fatto, crea anche altri giornali vecchi con galli alcuni che si ripetono, nuovi, ecc...//
...
- Due biglietti di sola andata della Kyoto Kōtsū (la compagnia degli autobus), Kyoto ↔ Kameoka (non treno, non auto); conto dello Shin-Miyako Hotel (l'albergo davanti alla stazione) dell'11/02 sera. //alla fermata normalmente un grgario della banda lo va  aprendere, se non ricordo male//
...
- Chiavetta di una cassetta di sicurezza (targhetta n. 0419) nascosta sotto la suola. //cosa vi è dentro? e dove è la cassetta di sicurezza? chi serve per aprirla?//

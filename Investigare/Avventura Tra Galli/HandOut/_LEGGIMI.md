...
**Di chi sono i galli.** La banda organizza la serata **e mette in gara i propri galli**, che alleva: quelli sono i
«galli di casa», scritti per primi. Gli **sfidanti** li portano gli altri — allevatori e appassionati del giro, che
pagano per entrare in gabbia.

**Dov'è la truffa, spiegata come la spiegheresti a un giocatore.** La percentuale è **quanto paga lo sfidante se
vince**: «sconto 7%» = 7 a 1, punti 1 e ne prendi 7. Quindi **più il gallo di casa vince, più il suo sfidante è dato
per spacciato e più alto diventa quello che paga**.

**Wasabi** è il gallo della banda e non ha mai perso: i suoi sfidanti pagavano **5**, poi **6**, poi **7** — sempre
di più, perché nessuno ci puntava un soldo. A gennaio lo sfidante è dato **10 a 1**: la **quota più alta di tutto
l'archivio**. Puntargli sopra è buttare via i soldi — **a meno che tu non sappia che Wasabi quella sera è sedato**.
Allora è una vincita certa moltiplicata per dieci. Tachibana ci mette ¥3,8 mln tramite tre prestanome e ne tornano
¥38 mln; Ōkubo, che ne aggiunge 3 suoi, con ¥5 mln ne incassa **50**.

Infatti Wasabi perde per la prima volta, e nel cartellone del 22 febbraio **non c'è più**. **La catena da far
notare**: 5 → 6 → 7 → **10**, e il campione sparisce.

**I cinque cartelloni sono stati rifatti il 2026-09-11** perché non rispettavano la regola della Storia — *«un gallo
...
1. **Il bossolo sotto l'orinatoio.** H-01 dice che al primo giro non è stato trovato — ed è giusto: lo trovano i PG (o Ito, se glielo chiedono). H-18 lo dà per acquisito «in sede di secondo sopralluogo». **Se i PG non lo cercano mai, quella riga della perizia non esiste** — ma **l'arma resta provata lo stesso**: l'autopsia (H-05) recupera **due proiettili** dal corpo, e la perizia (H-18) ne fa combaciare la rigatura con la Makarov di Kuroda. Il bossolo è una prova **in più**, non l'unica. Vale comunque la pena che qualcuno torni in quel bagno.

...
## Stanza del Mago — Biblioteca Arcana

### Accesso
Porta superiore. Chiusa ma semplice da aprire (non bloccata).
Porta inferiore chiusa e rinforzata anche magicamente. Se attivata la trappola chiusa magicamente.
...
#### Trigger:
PG esamina il tavolo principale, tocca le pergamene o i libri sopra.

#### Effetto:

> [!Leggere]
> Tocchi le pergamene. Una di troppo. 
> **_Tiro salvezza contro raggio della morte, se fallisce stordito per 1d4 round non può fare nulla_**
> Un bagliore azzurro attraversa la stanza come un'onda silenzioso. Raggiunge la porta in basso.
> Un rombo. Metallico. La porta inferiore — qualcosa è scattato.
> Guardate. La porta è ancora lì. Ma ora... sigillata. Rune blu brillano sul telaio. Poi svaniscono.
> Non si apre più.

#### Meccanica:

| Stato Porta Inferiore | Dettaglio                                     |
| --------------------- | --------------------------------------------- |
| Prima della trappola  | Chiusa, blindata, serve meccanismo per aprire |
| Dopo la trappola      | Sigillata magicamente + blindata              |
| Aprire                | Solo risolvendo l'enigma del piedistallo      |

### Contenuto — Tavolo Principale

| Oggetto                 | Dettaglio                                                       |
| ----------------------- | --------------------------------------------------------------- |
| Pergamene (6)           | Appunti di ricerca, illeggibili (inchiostro sbiadito)           |
...
| Oggetto                       | Quantità | Livello/Effetto          |
| ----------------------------- | -------- | ------------------------ |
| Pergamena Dardo Incantato     | 1        | 1° livello               |
| Pergamena Sonno               | 1        | 1° livello               |
| Pergamena Ragnatela           | 1        | 2° livello               |
| Pergamena Dissolvi Magie      | 1        | 3° livello               |
...
> In pochi secondi, spariti.
> Sotto il tappeto, solo polvere. 
...
**Ametista — Rubino — Smeraldo — Diamante — Zaffiro**

| Posizione | 1        | 2      | 3        | 4        | 5        |
|-----------|----------|--------|----------|----------|----------|
| Gemma     | Ametista | Rubino | Smeraldo | Diamante | Zaffiro  |
...
| Gemme Sbagliate | Danno | TS dimezza        |
| --------------- | ----- | ----------------- |
| 1               | 1d4   | no danno pieno    |
| 2               | 2d4   | no danno pieno    |
| 3               | 3d4   | si vs Incantesimi |
| 4               | 4d4   | si vs Incantesimi |
| 5               | 5d4   | si vs Incantesimi |
**Effetto:** Scarica elettrica dal piedistallo. Colpisce chi ha inserito le gemme.
**Dopo il danno:** Le gemme saltano fuori e cadono a terra. Possono riprovare.
...
| Oggetto | Valore |
|---------|--------|
| Monete (tavolo vuoto) | 57 mo |
| Gemme piccole | 75 mo |
| Penna d'argento | 15 mo |
| Pozione Cura (×2) | 100 mo |
| Pozione Invisibilità | 400 mo |
| Pozione Lettura Linguaggi | 200 mo |
| Veleno | 100 mo |
| Acqua santa (×2) | 50 mo |
| Pergamena Dardo Incantato | 100 mo |
| Pergamena Sonno | 100 mo |
| Pergamena Ragnatela | 200 mo |
| Pergamena Dissolvi Magie | 400 mo |
| Pergamena Protezione dal Male | 100 mo |
| Pergamene vuote (×12) | 24 mo |
| Tomo Evocazione | 500 mo |
| Libro Bianco | 25 mo |
| Libro Incantesimi | 800 mo |
| Grammatica Draconico | 200 mo |
| **Totale** | **~3446 mo** |
...
| Fonte                             | PX          |
| --------------------------------- | ----------- |
| Trappola porta (scoperta/evitata) | 50          |
| Enigma gemme (risolto)            | 150         |
| Tesoro                            | 3446        |
| **Totale**                        | **3646 PX** |

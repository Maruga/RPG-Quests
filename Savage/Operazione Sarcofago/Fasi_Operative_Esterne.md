...
> **Comando:** *"Bravo, siete in frequenza. Alpha ha passato il checkpoint nord. Proseguite lungo Rotta Grigia. Silenzio radio tranne aggiornamenti posizione ogni 15 minuti."*

I PG possono usare il dispositivo al polso per scrivere nella chat. Il Comando risponde con tono professionale. Informazioni disponibili su richiesta: rotta, meteo, livelli radiazioni, stato altre squadre.
...
> **Alpha:** *"Comando, Alpha in posizione intermedia. Nessun contatto. Procediamo."*

**10 minuti dopo:**

> **Alpha:** *"Comando, Alpha. Visivo sull'obiettivo. Struttura confermata. Porta visibile. Nessun movimento esterno."*
...
> **Comando (a Bravo):** *"Bravo, abbiamo perso il contatto con Alpha. Interferenze dalla struttura. Probabile attenuazione del segnale dal cemento armato. Procedete come pianificato."*



### Primo Sangue — I Mutanti Escono

Bravo è a 200 metri dal bunker quando succede.

**Comunicazione radio — Charlie (perimetro nord):**

> **Charlie:** *"Comando da Charlie. Movimento alla porta del bunker. Qualcosa sta— Cristo. Stanno uscendo. Ripeto: soggetti ostili in uscita dall’edificio."*

> **Comando:** *"Charlie, contenete. Bravo, alt. Posizione difensiva."*

> **Charlie:** *"Comando, sono… non sono normali. Si muovono— sono veloci. Apriamo il fuoco. APRIAMO IL FU—"* [statica]

**Descrizione:**

*Li vedete prima di sentirli. Figure che escono dalla bocca di cemento — non corrono, non camminano. Si muovono con una coordinazione innaturale, come un branco. Tute da lavoro arancioni macchiate di scuro. Volti sbagliati — vene nere, occhi che non sono più occhi.*

*Sono cinque. Sei. Sette. Continuano a uscire.*

*Poi uno si volta verso di voi.*

> **Nota per il GM:** Questo è il primo combattimento. I mutanti non puntano direttamente a Bravo — stanno uscendo, alcuni si dirigono verso il perimetro nord (Charlie), altri notano Bravo e deviano. L’IA li sta usando per saggiare le difese e seminare il caos.

**Composizione dell’ondata:**

| Tipo | Quantità | Comportamento |
|------|----------|---------------|
| Mutanti Standard (operai recenti) | 5-7 | Carica diretta, disordinata |
| Mutanti Avanzati (1986) | 1-2 | Restano indietro, osservano, si muovono sui fianchi |

**Tattiche:**

- I mutanti standard escono a ondate di 2-3, non tutti insieme
- Gli avanzati cercano di aggirare — se i PG si concentrano sugli standard, gli avanzati puntano agli scienziati
- Obiettivo primario: avvicinarsi a 3 metri (contagio). Uccidere è secondario
- Se i PG mantengono distanza e fuoco sostenuto, i mutanti si ritirano dentro dopo 3-4 round. L’IA preferisce attirarli all’interno

**Dopo il combattimento:**

*Il silenzio torna. Corpi a terra — quelli che avete abbattuto. Uno porta ancora un badge: nome, cognome, foto sorridente. Dalla porta del bunker non esce più nulla. Solo quell’aria stantia, fredda, che sale come un respiro.*

*Charlie non risponde alla radio. Comando conferma: Charlie è stata ingaggiata, ha subito perdite, si sta riorganizzando.*

> **Comando:** *"Bravo, Alpha non risponde. Charlie ha preso contatto con ostili in uscita, situazione contenuta. Il perimetro tiene. Procedete con la missione. Non c’è un piano B."*


### Decisione di Ingresso

Il team è davanti alla porta aperta. Buio oltre la soglia. Alpha è in silenzio.

> **Nota per il GM:** Questo è un momento di pausa. Lascia che i giocatori parlino tra loro, decidano la formazione, controllino l'equipaggiamento. Non forzare l'ingresso. Quando entrano, entrano.

**Formazione suggerita (se i PG non decidono):**

Ryan (armi pesanti) al centro-retro, Laurent (breacher) in testa, Marco e James ai fianchi, Mikhail in ricognizione avanzata. Scienziati protetti al centro.

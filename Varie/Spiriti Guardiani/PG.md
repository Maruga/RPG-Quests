...
- Tutti gli attributi partono da **4**
- Distribuiti **12 punti** (base) tra i 6 attributi
- Nessun attributo supera **9** o scende sotto **4**
- Ki iniziale: attributo più basso + dado più alto di 2d6
- Dopo il collegamento con lo spirito: **+1 attributo dello spirito, +3 Ki**
- Ogni evoluzione armi successiva: **+1 punto attributo (dove vuole il PG) + 1 Ki**
...
|PG|Spirito|Caratteristica|Attr. più alto (dopo spirito)|Ki (dopo spirito)|Arma finale|
|---|---|---|---|---|---|
|Il Barbone|Salamandra / Caesar|Scintilla|8|13|Malleus Iacta|
|Il Ladruncolo|Colibrì / Aurelian|Battito|8|12|Geminae Restitutor|
|La Truffatrice|Fennec / Scipio|Eco|8|12|Vox Africani|
|Il Debitore|Medusa Luna / Augustus|Flusso|8|13|Flagellum Pacis + Scutum Auctoritas|
|Il Falsario|Pangolino / Aurelius|Radice|8|11|Virtus Imperatoris + Clipeus Meditationis|
|L'Eretico|Drago di Mare Foglia / Spartacus|Ombra|8|12|Hasta Libertatis|

## Progressione

|Momento|Bonus|
|---|---|
|Collegamento spirito (Terme)|+1 attributo spirito, +3 Ki, armi Forma 1|
|Vittoria Boss 1 — Primus (Via Sacra)|+1 attributo (a scelta), +1 Ki, armi Forma 2|
|Incontro con Tellus (Camera della Madre)|+1 attributo (a scelta), Ki al massimo, armi Forma 3|